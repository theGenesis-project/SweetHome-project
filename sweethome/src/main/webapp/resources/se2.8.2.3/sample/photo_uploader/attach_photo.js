    ...
    function html5Upload() {	
    	...
    	sUploadURL= '/sweethome/file_uploader_html5'; 	//upload URL
	...
	function onAjaxError (){
 	...
 	function callFileUploader (){
 		oFileUploader = new jindo.FileUploader(jindo.$("uploadInputBox"),{
 			sUrl  : '/sweethome/file_uploader',	//샘플 URL입니다.
 	        sCallback : '/resources/se2.8.2.3/sample/photo_uploader/callback.html',	//업로드 이후에 iframe이 redirect될 콜백페이지의 주소
